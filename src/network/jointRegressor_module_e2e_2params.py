...
from criterions.e2e_joint_eval_metric_2params import RPJointEstimationEvaluation
from criterions.e2e_joint_loss_2params import RPMultiTaskLoss
...
class JointRegressorModuleE2E(LightningModule):
    ...
    def training_step(
        ...
        """
        loss_tr, loss_volume = self.model_step(batch)
        ...
        # ------------------- total loss -------------------
        total_loss = +self.tr_weight * loss_tr + self.volume_weight * loss_volume
