...
from criterions.e2e_joint_eval_metric import RPJointEstimationEvaluation
from criterions.e2e_joint_loss import RPMultiTaskLoss
...
class JointRegressorModuleE2E(LightningModule):
    def __init__(
        ...
        self.train_huber_alcons = MeanMetric()
        self.val_l1_alcons = MeanMetric()
        ...
        self.val_l1_best_alcons = MinMetric()
    ...
    def training_step(
        ...
        self.train_huber_alcons(loss_alcons)
    ...
    def validation_step(
        ...
        self.val_l1_alcons(loss_alcons)
        ...
        self.val_corrcoef_alcons(corr_alcons)
    ...
    def on_validation_epoch_end(self) -> None:
        ...
        metric_l1_alcons = self.val_l1_alcons.compute()  # get current val metric
        ...
        self.val_l1_best_alcons(metric_l1_alcons)
        ...
        self.val_l1_best_volume(metric_l1_volume)
        self.val_l1_best_dist_src(metric_l1_distSrc)
        ...
        total_loss_best = (
            ...
            + self.alcons_weight * self.val_l1_best_alcons
        ...
        self.log(
            ...
            self.val_l1_best_alcons.compute(),
            sync_dist=True,
            prog_bar=True,
        )
    ...
    def predict_step(
        ...
        if sti_hat.dim() == 2:
            if padding_mask is not None and padding_mask.any():
                ...
                d50_hat = d50_hat.mean(dim=1) * 100  # convert to percentage
