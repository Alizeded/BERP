...
class DistSrcRegressorModuleBaselineFullCNN(LightningModule):
    def __init__(
        self,
        net: torch.nn.Module,
    ...
    def training_step(
        ...
        the input tensor of raw, target dist_src.
...
if __name__ == "__main__":
    ...
    _ = DistSrcRegressorModuleBaselineFullCNN(cfg.model.distSrcRegressorModule)
