...
class DistSrcRegressorModule(LightningModule):
    def __init__(
        ...
        self.criterion_train = HuberLoss(
            phase="train", module="distance", ablation=True
        )
        self.criterion_val = HuberLoss(phase="val", module="distance", ablation=True)
        self.criterion_test = HuberLoss(phase="test", module="distance", ablation=True)
