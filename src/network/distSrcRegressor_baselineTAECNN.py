...
class DistSrcRegressorModuleBaselineTAECNN(LightningModule):
    def __init__(
        self,
        net: torch.nn.Module,
        ...
        # loss function
        self.loss_fn_dist_src = RMSELoss()
...
if __name__ == "__main__":
    ...
    _ = DistSrcRegressorModuleBaselineTAECNN(cfg.model.distSrcRegressorModule)
