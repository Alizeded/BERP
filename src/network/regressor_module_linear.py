...
class rirRegressorModule(LightningModule):
    def __init__(
        ...
        # loss function
        self.criterion_train = HuberLoss(phase="train", module="rir", ablation=True)
        self.criterion_val = HuberLoss(phase="val", module="rir", ablation=True)
        self.criterion_test = HuberLoss(phase="test", module="rir", ablation=True)
