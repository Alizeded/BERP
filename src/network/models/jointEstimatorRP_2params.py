...
class JointEstimator(nn.Module):
    ...
    def __init__(
        ...
        # parameteric predictor for tr or ts if unrelated params
        ...
        # parameteric predictor for volume or dist_src if unrelated params
    ...
    def forward(
        ...
        if self.decoder_type == "parametric_predictor":
            tr_hat, volume_hat = self.parametric_predictor_forward(x)
        else:
            raise NotImplementedError("Only parameteric predictor is supported")
