...
class volumeRegressorModuleBaselineTAECNN(LightningModule):
    def __init__(
        self,
        net: torch.nn.Module,
...
if __name__ == "__main__":
    ...
    _ = volumeRegressorModuleBaselineTAECNN(cfg.model.volumeRegressorModule)
