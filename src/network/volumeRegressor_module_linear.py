...
class VolumeRegressorModule(LightningModule):
    def __init__(
        ...
        # loss function
        self.criterion_train = HuberLoss(phase="train", module="volume", ablation=True)
        self.criterion_val = HuberLoss(phase="val", module="volume", ablation=True)
        self.criterion_test = HuberLoss(phase="test", module="volume", ablation=True)
