...
class OriSrcRegressorModuleBaselineFullCNN(LightningModule):
    def __init__(
        self,
        net: torch.nn.Module,
    ...
    def validation_step(
        ...
        :param batch: A batch of data (a tuple) containing the input tensor of raw,
            target clean, target num_occu, target ori_src, target Th, target Tt.
        :param batch_idx: The index of the current batch.
        """
        loss_ori_azimuth, loss_ori_elevation = self.model_step(batch)
...
if __name__ == "__main__":
    ...
    _ = OriSrcRegressorModuleBaselineFullCNN(cfg.model.oriSrcRegressorModule)
