...
class DistSrcRegressorModuleBaselineREnet(LightningModule):
    def __init__(
        self,
        net: torch.nn.Module,
    ...
    def model_step(
        ...
        dist_src = repeat(dist_src, "b -> b c", c=dist_src_hat.shape[1])
...
if __name__ == "__main__":
    ...
    _ = DistSrcRegressorModuleBaselineREnet(cfg.model.distSrcRegressorModule)
