...
class ReverbSpeechDataModuleBaselineReal(LightningDataModule):
    ...
    def __init__(
        ...
        data_dir: str = "data/retrans_audio.data",
    ...
    def _get_item_and_labels(self):
        if os.path.isfile(
            os.path.join(self._data_dir, "real_audio.metadata/test_manifest.csv")
        ):
            ...
            raw_test = [
                ...
                for idx in manifest_test_df["realRecording"].tolist()
            ]
...
if __name__ == "__main__":
    ...
    cfg = omegaconf.OmegaConf.load(
        root / "configs" / "data" / "ReverbSpeechBaselineBUT.yaml"
    )
