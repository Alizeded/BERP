...
def synth_mixed_speech(
    ...
    # exclude early reflections (initial 50 ms)
    rir = rir[:, int(0.05 * fs) :]
...
num_occ = pd.read_csv("./data/RIR_aggregated/RIR.metadata/num_occu_uniform.csv")
...
def mixed_speech(i):
    ...
    mixed_speech_savepath = "./data/mixed_speech_noise/mixed_speech_uniform.data"

    mixed_speech_info_savepath = (
        "./data/mixed_speech_noise/mixed_speech_uniform.metadata"
    )
    ...
    mixed_speech_label_savepath = (
        "./data/mixed_speech_noise/mixed_speech_label_uniform.data"
    )
...
#     "./data/mixed_speech_noise/reverb_mixed_speech_manifest_uniform.csv",
#     index=False,
# )
# mixed_speech_manifest.to_csv(
#     "./data/mixed_speech_noise/mixed_speech_manifest_uniform.csv",
#     index=False,
# )
