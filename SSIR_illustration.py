...
ax[0].set_ylabel("Temporal Envelope", fontsize=12, fontname="serif")
...
ax[0].text(0.65, 0.15, "RMSE: " + str(rmse), transform=ax[0].transAxes)
ax[1].plot(t_rir, rir_sample_norm, color="k")
ax[1].set_xlabel("Time [s]", fontsize=12, fontname="serif")
ax[1].set_ylabel("Amplitude", fontsize=12, fontname="serif")
ax[1].set_xlim([0, 1.5])
ax[1].set_ylim([-1, 1])
